...
public class Sports_fragment extends Fragment {
   ...
   private RecyclerView rv_sports_frag;
    String country = "in";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rv_sports_frag = view.findViewById(R.id.rv_sports_frag);
        list= new ArrayList<>();
        rv_sports_frag.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter= new Adapter(getContext(), list);
        rv_sports_frag.setAdapter(adapter);
